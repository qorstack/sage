...
Knowlyx แก้ทั้ง 3 ด้วยการ **บังคับ AI ให้ call MCP tools ก่อน** ไม่ใช่หวังว่า AI จะอ่าน markdown (ซึ่งหลักฐานชี้ว่า AI ignore บ่อย)
...
→ Knowlyx ให้ intuition นี้แบบ structured ผ่าน MCP tools

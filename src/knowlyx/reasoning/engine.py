...
from knowlyx.models.schema import CognitionReport, ScanResult
...
class ReasoningEngine:
    ...
    def _relevant_conventions(self, domain: str):
        from knowlyx.models.schema import Convention
        return [
    ...
    def _relevant_assets(self, domain: str):
        from knowlyx.models.schema import ReusableAsset
